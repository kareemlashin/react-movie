...
//import { Test } from './TopRate.styles';
import { withTranslation } from 'react-i18next';
import { NavLink } from 'react-router-dom';
import { getShared } from '../../core/action/action';

class TopRate extends PureComponent { 
  constructor(props) {
    super(props);
          ...
          <div>
            <div className="container  my-5">
              <div className="border-bottom mb-3 pb-3 px-2 d-flex justify-content-between">
                ...
                <NavLink to="/Scrolling" className="text-white">
                {t('seeMore')}
                </NavLink>
              </div>
              ...
              {this.props.shared.slice(3,6).map((item) => (
              <div
...
const mapStateToProps = state => ({
  shared: state.reducers.shared,
});

const mapDispatchToProps = dispatch => ({
   dataTrend: (page) => dispatch(getShared(page)),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withTranslation()(TopRate));
